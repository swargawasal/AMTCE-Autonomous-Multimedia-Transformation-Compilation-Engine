...
logger = logging.getLogger("SakshiKaraoke")

# --- CONFIG ---
INPUT_VIDEO = r"D:\Autonomous Multimedia Transformation & Compilation Engine (AMTCE)\downloads\Sakshi_malik_1.mp4"
TEMP_DIR = os.path.join(root_dir, "temp", "sakshi_test")
OUTPUT_VIDEO = os.path.join(root_dir, "final_sakshi_karaoke.mp4")
...
async def run_test():
    ...
    logger.info(f"🧠 Running Professional V3 for Sakshi Malik...")
    ...
    logger.info("🛠️ Building Karaoke Master Complex...")
    chunk_size = 3
    ...
    Y_POS = "h*0.72"
    BASE_FONT_SIZE = 120
    PIXELS_PER_CHAR = BASE_FONT_SIZE * 0.55
    ...
    cmd = [
        ...
        "-filter_complex_script", os.path.join(TEMP_DIR, "karaoke.txt"),
        "-map", "[v_final]", "-map", "1:a",
